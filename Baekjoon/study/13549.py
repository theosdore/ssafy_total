...
while True:
    ...
    doubletempPos = tempPos
    while True:
        if doubletempPos != 0 and doubletempPos*2 < 200000 and tempTime < visited[doubletempPos*2] and doubletempPos < K*2 :
            que.append((doubletempPos*2, tempTime))
            visited[doubletempPos*2] = tempTime
            doubletempPos *= 2
        else:
            break
